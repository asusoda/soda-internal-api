...
class DBConnect:
    def __init__(self, db_url="sqlite:///./user.db") -> None:
        ...
        self.db = self.SessionLocal()  # Create a persistent session instance
...
# user = UserModel(name="John Doe")  # Assuming UserModel is a valid SQLAlchemy model
# db_connect.create_user(user)
# db_connect.close()
