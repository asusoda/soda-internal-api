...
def notion_webhook():
    ...
    """
    # Start a Sentry transaction for the webhook request
    with start_transaction(op="webhook", name="notion_webhook_sync") as transaction:
...
def delete_all_calendar_events():
    ...
    """
    with start_transaction(op="admin", name="delete_all_events_route") as transaction:
        route_error_handler.transaction = transaction
