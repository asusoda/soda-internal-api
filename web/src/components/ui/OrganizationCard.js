    ...
    <div className={styles.card}>
      ...
      <div className="flex space-x-2">
        <button
          ...
          className={`flex-1 px-4 py-2.5 ${styles.buttonPrimary} backdrop-blur-sm rounded-lg text-sm font-medium transition-all duration-200 border hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]`}
        >
        ...
        <button
          ...
          className={`px-4 py-2.5 ${styles.buttonSecondary} backdrop-blur-sm rounded-lg text-sm font-medium transition-all duration-200 border hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]`}
        >
          <div className="flex items-center justify-center space-x-2">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {showRemove && (
          <button
            ...
            className={`px-4 py-2.5 ${styles.buttonDanger} backdrop-blur-sm rounded-lg text-sm font-medium transition-all duration-200 border hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]`}
          >
            <div className="flex items-center justify-center space-x-2">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
