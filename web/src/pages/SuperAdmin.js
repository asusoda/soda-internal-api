      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-8">
          ...
          <button
            ...
            className="px-4 py-2 bg-gray-700/50 hover:bg-gray-600/50 backdrop-blur-sm rounded-md text-sm font-medium transition-colors border border-gray-600/50"
          >
        ...
        <div className="mb-8">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            {/* Config Card */}
            <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-lg border border-gray-700/50 hover:border-gray-600/50 transition-colors">
              ...
              {dashboardData.available_guilds.map((guild) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full px-3 py-2 bg-green-600/50 hover:bg-green-700/50 backdrop-blur-sm rounded-md text-sm font-medium transition-colors border border-green-500/50"
                  >
                    Add Organization
                  </button>
                </div>
                ...
                >
                  ...
                  <div className="flex space-x-2">
                    ...
                    <button
                      ...
                      className="px-3 py-2 bg-red-600/50 hover:bg-red-700/50 backdrop-blur-sm rounded-md text-sm font-medium transition-colors border border-red-500/50"
                    >
                      Remove
                    </button>
                  </div>
