...
from discord_modules.cogs import GameCog



class QuestionPost(discord.ui.View):

        def __init__ (self, question: JeopardyQuestion, voice: discord.StageChannel, cog: GameCog, question_uuid: Optional[str], avoid):
            """
